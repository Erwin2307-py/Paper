...
# 3) Baue den Pfad zum Paket "paperqa" innerhalb von "modules/paper-qa"
...
# 4) Füge den Ordner "modules/paper-qa" in den sys.path ein, damit Python das Paket "paperqa" findet
