...
#############################################
# API Selection mit Checkboxen (keine multiselect)
#############################################
def page_api_selection():
    st.title("API Selection & Connection Status")

    st.write("Wähle im Folgenden deine gewünschten APIs durch Setzen eines Häkchens.")
    st.markdown(
        """
        <style>
