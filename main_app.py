...
# ------------------------------------------------------------------
# PaperAnalyzer-Klasse, AlleleFrequencyFinder etc. (bereits definiert oben)
# ------------------------------------------------------------------

# ------------------------------------------------------------------
# Hauptseite: Analyze Paper
# ------------------------------------------------------------------
def page_analyze_paper():
    ...
    # --- Outlier-Check-Funktion ---
    def do_outlier_logic(paper_map: dict) -> (list, str):
        # (Hier unverändert lassen, oder minimal anpassen, s.o.)
        pass  # Du kannst Deine Outlier-Logik hier reinkopieren
    ...
    if uploaded_files and api_key:
        ...
        with col_left:
            if st.button("Analyse starten (Einzel-Modus)"):
                # ... hier Deine Einzel-Analyse ...
                pass
        
        with col_right:
            if st.button("Widerspruchsanalyse (Hochgeladene Paper)"):
                # ... hier die Widerspruchsanalyse für hochgeladene Paper ...
                pass
    ...
    if "scored_list" not in st.session_state or not st.session_state["scored_list"]:
        if "search_results" in st.session_state and st.session_state["search_results"]:
            ...
            pass  # Hier ggf. chatgpt_online_search_with_genes(...)
        else:
    ...
    # ... (Liste + Auswahl + Anzeige)...

    # ------------------- Button für Widerspruchsanalyse (Gescorte Paper) -------------------
    st.write("---")
    st.header("Widerspruchsanalyse (Gescorte Paper)")
    if st.button("Widerspruchsanalyse (Gescorte Paper)"):
        pass  # Hier Deine Logik für die gescorten Paper
