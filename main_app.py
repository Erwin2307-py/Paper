...
def page_analyze_paper():
    ...
    # Hinweis: Die Auswahl der Analysequelle für Widersprüche erfolgt hier nicht mehr via Sidebar,
    # da wir jeweils zwei Buttons im Hauptfenster haben.
...
"""
            ...
            # Falls Rückgabe in Code-Blöcken erfolgt:
...
"""
    ...
    # ------------------------- Haupt-Logik -------------------------
    # Analyse (Einzelmodus oder Compare-Mode)
        ...
        if st.button("Alle Analysen durchführen & in Excel speichern (Multi)"):
            with st.spinner("Analysiere alle hochgeladenen PDFs (für Excel)..."):
                ...
                for fpdf in selected_files_for_excel:
                    ...
                    # D10-D12: Erste drei Genotypen, E10-E12: Populationsfrequenz
                    for i in range(3):
                        row_genotype = 10 + i
                    ...
                    # Ggf. weitere Informationen könnten hier hinzugefügt werden.
    ...
    # -------------------------
    # Einzelanalyse der gescorten Paper
    # -------------------------
    st.write("---")
    ...
    # -------------------------
    # Zwei Buttons für die Widerspruchsanalyse (immer sichtbar)
    # -------------------------
    st.write("---")
