...
# OpenAI API-Schlüssel prüfen und setzen
api_key = None
...
st.set_page_config(page_title="Multi-Modul Demo mit PaperQA2", layout="wide")
...
################################################################################
# 4) Haupt-App mit Navigation
################################################################################

def main():
    st.title("📄 Multi-Modul Demo mit PaperQA2")
    st.write("Laden Sie ein PDF hoch und nutzen Sie PaperQA2 für Fragen.")
    ...
    # Button zum Starten von PaperQA2
    ...
    if st.session_state["current_page"] == "home":
        st.write("📌 Bitte laden Sie ein PDF hoch und starten Sie PaperQA2.")
